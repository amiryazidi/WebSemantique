...
// TODO Auto-generated catch block
	 ...
	 * 
	 * @param args + Entree: - l'objet model Jena - Namespace de l'ontologie - Le
	 *             nom de la première Instance - Le nom de la propriete - Le nom de
	 *             la deuxieme Instance + Sortie: le resultat de la requete en
	 *             String
	 */
	 ...
	 * 
	 * @param args + Entree: - l'objet model Jena - Namespace de l'ontologie - Le
	 *             nom de la premiere Instance - Le nom de la propriete - Le nom de
	 *             le deuxieme Instance + Sortie: le resultat de la requete en
	 *             String
	 */
	 ...
	 * 
	 * @param args + Entree: - l'objet model Jena - Namespace de l'ontologie - Le
	 *             nom de l'Instance - Le nom de la propriete - La valeur + Sortie:
	 *             le resultat de la requete en String
	 */
	 ...
	 * 
	 * @param args + Entree: - l'objet model Jena - Namespace de l'ontologie - Le
	 *             nom de l'Instance - Le nom de la propriete + Sortie: le resultat
